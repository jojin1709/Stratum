...
/**
 * Every figure here is measured from the running system on each load. Nothing on this
 * page has a fallback constant — if a subsystem cannot answer, it says so.
 */
...
export default function OverviewPage() {
  ...
  return (
    <>
      ...
      <div className="mb-5 flex flex-col rounded border border-line bg-surface sm:flex-row">
